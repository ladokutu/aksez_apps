...
const TemporaryDrawer = (props) => {
  ...
  const sidebar = [
	  ...
	  { name: 'Organization', icon : <LocationCity/> ,link: '/ds/home', id: 3 ,
		child: [
			{ name: 'Structure', icon : <Padding/> ,link: '/my/attendance', id:31 },
			{ name: 'Job Desk', icon : <PersonPinCircle/> ,link: '/my/request_form', id:32 },
		]
	  },
	  { name: 'Recruitment', icon : <PersonSearch/> ,link: '/ds/home', id: 4 ,
		child: [
			{ name: 'List Recruitment', icon : <Reorder/> ,link: '/my/attendance', id:41 },
			
		]
	  },
	  { name: 'Training', icon : <RunCircle/> ,link: '/ds/home', id: 5 ,
		child: [
			{ name: 'Request Training', icon : <PlaylistAdd/> ,link: '/my/attendance', id:51 },
			{ name: 'Approval Training', icon : <PlaylistAddCheck/> ,link: '/my/request_form', id:52 },
		]
	  },
	  { name: 'Payrool', icon : <MonetizationOn/> ,link: '/ds/home', id: 6 ,
		child: []
	  },
