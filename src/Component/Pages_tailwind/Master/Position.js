				  ...
				  <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
					<header className="bg-white">
						  <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
							<h1 className="text-3xl font-bold text-gray-900">Master Position</h1>
						  </div>
					</header>
					...
					<div className="sm:flex sm:items-start">
								...
								<div className="grid grid-cols-8 gap-8">
									...
									<div className="col-span-8">
									  ...
									  <input required
										type="text" value={id_position} onChange={(e) => setIDPosition(e.target.value)} 
										name="id_position"
										id="id_position"
									...
									<div className="col-span-8">
									  ...
									  <input 
										type="text" value={position_name} onChange={(e) => setPosition(e.target.value)} 
										name="position_name"
										id="position_name"
										className={classinput}
									  />
